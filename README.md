...
cp .env.example .env
# Fill in your API keys (GitHub OAuth, Discord Bot Token, MongoDB URI, OpenAI Key)
...
- **Sanyam Nandal** — [GitHub](https://github.com/sanyamnandal56-netizen) · [LinkedIn](https://www.linkedin.com/in/sanyam-nandal-4466051b0)
- **Shubham Sharma** — [GitHub](https://github.com/ShubhamSharma0803)
