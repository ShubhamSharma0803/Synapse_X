...
/* ══════════════════════════════════════
   SCROLL STACK — ReactBits Component
   ══════════════════════════════════════ */
...
const ScrollStack = ({
    ...
    /* Use offsetTop chain — immune to CSS transforms (no feedback loop) */
    ...
    useLayoutEffect(() => {
        ...
        /* Cache layout offsets once — immune to transform feedback */
        cardOffsetsRef.current = cards.map(c => getElementOffset(c));

        const endEl = useWindowScroll
            ? document.querySelector('.scroll-stack-end')
            : scroller.querySelector('.scroll-stack-end');
        endOffsetRef.current = endEl ? getElementOffset(endEl as HTMLElement) : 0;
